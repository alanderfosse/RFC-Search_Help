class ZCL_ZSEARCH_HELP_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSEARCH_HELP_MPC==========CP' ##NO_TEXT.
...
CLASS ZCL_ZSEARCH_HELP_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSEARCH_HELP_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSEARCH_HELP_MPC=>TS_BRFSHCUSTOMID' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250227132937'.                  "#EC NOTEXT
